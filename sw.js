...
var CACHE = 'tenways-tasks-1.11.17';
var BASE = self.registration.scope; // .../webapp/ - only app files live here
var SHELL = [
  'index.html', 'styles.css?v=1.11.17', 'config.js?v=1.11.17', 'manifest.webmanifest?v=1.11.17',
  'js/client.js?v=1.11.17', 'js/app.js?v=1.11.17', 'js/auth.js?v=1.11.17', 'vendor/supabase.js?v=1.11.17',
