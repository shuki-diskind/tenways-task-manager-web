...
var CACHE = 'tenways-tasks-1.11.20';
var BASE = self.registration.scope; // .../webapp/ - only app files live here
var SHELL = [
  'index.html', 'styles.css?v=1.11.20', 'config.js?v=1.11.20', 'manifest.webmanifest?v=1.11.20',
  'js/client.js?v=1.11.20', 'js/app.js?v=1.11.20', 'js/auth.js?v=1.11.20', 'vendor/supabase.js?v=1.11.20',
