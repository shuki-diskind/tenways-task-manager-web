...
var CACHE = 'tenways-tasks-1.11.12';
var BASE = self.registration.scope; // .../webapp/ - only app files live here
var SHELL = [
  'index.html', 'styles.css?v=1.11.12', 'config.js?v=1.11.12', 'manifest.webmanifest?v=1.11.12',
  'js/client.js?v=1.11.12', 'js/app.js?v=1.11.12', 'js/auth.js?v=1.11.12', 'vendor/supabase.js?v=1.11.12',
