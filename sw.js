...
var CACHE = 'tenways-tasks-1.11.14';
var BASE = self.registration.scope; // .../webapp/ - only app files live here
var SHELL = [
  'index.html', 'styles.css?v=1.11.14', 'config.js?v=1.11.14', 'manifest.webmanifest?v=1.11.14',
  'js/client.js?v=1.11.14', 'js/app.js?v=1.11.14', 'js/auth.js?v=1.11.14', 'vendor/supabase.js?v=1.11.14',
