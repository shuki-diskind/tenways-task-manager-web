...
var CACHE = 'tenways-tasks-1.11.13';
var BASE = self.registration.scope; // .../webapp/ - only app files live here
var SHELL = [
  'index.html', 'styles.css?v=1.11.13', 'config.js?v=1.11.13', 'manifest.webmanifest?v=1.11.13',
  'js/client.js?v=1.11.13', 'js/app.js?v=1.11.13', 'js/auth.js?v=1.11.13', 'vendor/supabase.js?v=1.11.13',
