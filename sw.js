...
var CACHE = 'tenways-tasks-1.11.27';
var BASE = self.registration.scope; // .../webapp/ - only app files live here
var SHELL = [
  'index.html', 'styles.css?v=1.11.27', 'config.js?v=1.11.27', 'manifest.webmanifest?v=1.11.27',
  'js/client.js?v=1.11.27', 'js/app.js?v=1.11.27', 'js/auth.js?v=1.11.27', 'vendor/supabase.js?v=1.11.27',
