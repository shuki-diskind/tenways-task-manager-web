...
var CACHE = 'tenways-tasks-1.10.0';
var BASE = self.registration.scope; // .../webapp/ - only app files live here
var SHELL = [
  'index.html', 'styles.css?v=1.10.0', 'config.js?v=1.10.0', 'manifest.webmanifest?v=1.10.0',
  'js/client.js?v=1.10.0', 'js/app.js?v=1.10.0', 'js/auth.js?v=1.10.0', 'vendor/supabase.js?v=1.10.0',
