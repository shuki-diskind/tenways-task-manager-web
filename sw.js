...
var CACHE = 'tenways-tasks-1.11.9';
var BASE = self.registration.scope; // .../webapp/ - only app files live here
var SHELL = [
  'index.html', 'styles.css?v=1.11.9', 'config.js?v=1.11.9', 'manifest.webmanifest?v=1.11.9',
  'js/client.js?v=1.11.9', 'js/app.js?v=1.11.9', 'js/auth.js?v=1.11.9', 'vendor/supabase.js?v=1.11.9',
