...
var CACHE = 'tenways-tasks-1.11.22';
var BASE = self.registration.scope; // .../webapp/ - only app files live here
var SHELL = [
  'index.html', 'styles.css?v=1.11.22', 'config.js?v=1.11.22', 'manifest.webmanifest?v=1.11.22',
  'js/client.js?v=1.11.22', 'js/app.js?v=1.11.22', 'js/auth.js?v=1.11.22', 'vendor/supabase.js?v=1.11.22',
