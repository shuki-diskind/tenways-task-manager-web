...
var CACHE = 'tenways-tasks-1.11.31';
var BASE = self.registration.scope; // .../webapp/ - only app files live here
var SHELL = [
  'index.html', 'styles.css?v=1.11.31', 'config.js?v=1.11.31', 'manifest.webmanifest?v=1.11.31',
  'js/client.js?v=1.11.31', 'js/app.js?v=1.11.31', 'js/auth.js?v=1.11.31', 'vendor/supabase.js?v=1.11.31',
