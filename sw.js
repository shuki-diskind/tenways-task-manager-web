...
var CACHE = 'tenways-tasks-1.6.1';
var BASE = self.registration.scope; // .../webapp/ - only app files live here
var SHELL = [
  'index.html', 'styles.css?v=1.6.1', 'config.js?v=1.6.1', 'manifest.webmanifest?v=1.6.1',
  'js/client.js?v=1.6.1', 'js/app.js?v=1.6.1', 'js/auth.js?v=1.6.1', 'vendor/supabase.js?v=1.6.1',
