...
var CACHE = 'tenways-tasks-1.11.23';
var BASE = self.registration.scope; // .../webapp/ - only app files live here
var SHELL = [
  'index.html', 'styles.css?v=1.11.23', 'config.js?v=1.11.23', 'manifest.webmanifest?v=1.11.23',
  'js/client.js?v=1.11.23', 'js/app.js?v=1.11.23', 'js/auth.js?v=1.11.23', 'vendor/supabase.js?v=1.11.23',
